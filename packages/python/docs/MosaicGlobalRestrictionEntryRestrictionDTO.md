...
mosaic_global_restriction_entry_restriction_dto_form_dict = mosaic_global_restriction_entry_restriction_dto.from_dict(mosaic_global_restriction_entry_restriction_dto_dict)
```

...
embedded_namespace_metadata_transaction_dto_form_dict = embedded_namespace_metadata_transaction_dto.from_dict(embedded_namespace_metadata_transaction_dto_dict)
```

...
class RestrictionAccountRoutesApi:
    ...
    def get_account_restrictions(
        ...
        _param = self._get_account_restrictions_serialize(
            address=address,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountRestrictionsInfoDTO",
            '404': "ModelError",
            '409': "ModelError",
        }
    ...
    @validate_call
    def get_account_restrictions_with_http_info(
        self,
        address: Annotated[StrictStr, Field(description="Account address.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_account_restrictions_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="Account address.")],
        _request_timeout: Union[
            None,
    ...
    def _get_account_restrictions_serialize(
        self,
        address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/restrictions/account/{address}',
    ...
    @validate_call
    def get_account_restrictions_merkle(
        self,
        address: Annotated[StrictStr, Field(description="Account address.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_account_restrictions_merkle_serialize(
            address=address,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_account_restrictions_merkle_with_http_info(
        self,
        address: Annotated[StrictStr, Field(description="Account address.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_account_restrictions_merkle_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="Account address.")],
        _request_timeout: Union[
            None,
    ...
    def _get_account_restrictions_merkle_serialize(
        self,
        address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/restrictions/account/{address}/merkle',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def search_account_restrictions(
        self,
        ...
        _param = self._search_account_restrictions_serialize(
            address=address,
            page_size=page_size,
    ...
    @validate_call
    def search_account_restrictions_with_http_info(
        self,
        address: Annotated[Optional[StrictStr], Field(description="Filter by address involved in the transaction. An account's address is considered to be involved in the transaction when the account is the sender, recipient, or it is required to cosign the transaction. This filter cannot be combined with ``recipientAddress`` and ``signerPublicKey`` query params. ")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=10)]], Field(description="Select the number of entries to return.")] = None,
        page_number: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by page number.")] = None,
    ...
    @validate_call
    def search_account_restrictions_without_preload_content(
        self,
        address: Annotated[Optional[StrictStr], Field(description="Filter by address involved in the transaction. An account's address is considered to be involved in the transaction when the account is the sender, recipient, or it is required to cosign the transaction. This filter cannot be combined with ``recipientAddress`` and ``signerPublicKey`` query params. ")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=10)]], Field(description="Select the number of entries to return.")] = None,
        page_number: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by page number.")] = None,
    ...
    def _search_account_restrictions_serialize(
        self,
        address,
        page_size,
        page_number,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/restrictions/account',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

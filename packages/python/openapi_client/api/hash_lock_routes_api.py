...
class HashLockRoutesApi:
    ...
    def get_hash_lock(
        self,
        hash: Annotated[StrictStr, Field(description="Filter by hash.")],
        ...
        _param = self._get_hash_lock_serialize(
            hash=hash,
    ...
    @validate_call
    def get_hash_lock_with_http_info(
        self,
        hash: Annotated[StrictStr, Field(description="Filter by hash.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_hash_lock_without_preload_content(
        self,
        hash: Annotated[StrictStr, Field(description="Filter by hash.")],
        _request_timeout: Union[
            None,
    ...
    def get_hash_lock_merkle(
        ...
        _param = self._get_hash_lock_merkle_serialize(
            hash=hash,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_hash_lock_merkle_with_http_info(
        self,
        hash: Annotated[StrictStr, Field(description="Filter by hash.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_hash_lock_merkle_without_preload_content(
        self,
        hash: Annotated[StrictStr, Field(description="Filter by hash.")],
        _request_timeout: Union[
            None,
    ...
    def _get_hash_lock_merkle_serialize(
        self,
        hash,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/lock/hash/{hash}/merkle',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_hash_lock(
        ...
        _param = self._search_hash_lock_serialize(
            address=address,
            page_size=page_size,
    ...
    @validate_call
    def search_hash_lock_with_http_info(
        self,
        address: Annotated[Optional[StrictStr], Field(description="Filter by address involved in the transaction. An account's address is considered to be involved in the transaction when the account is the sender, recipient, or it is required to cosign the transaction. This filter cannot be combined with ``recipientAddress`` and ``signerPublicKey`` query params. ")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=10)]], Field(description="Select the number of entries to return.")] = None,
        page_number: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by page number.")] = None,
    ...
    @validate_call
    def search_hash_lock_without_preload_content(
        self,
        address: Annotated[Optional[StrictStr], Field(description="Filter by address involved in the transaction. An account's address is considered to be involved in the transaction when the account is the sender, recipient, or it is required to cosign the transaction. This filter cannot be combined with ``recipientAddress`` and ``signerPublicKey`` query params. ")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=10)]], Field(description="Select the number of entries to return.")] = None,
        page_number: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by page number.")] = None,
    ...
    def _search_hash_lock_serialize(
        self,
        address,
        page_size,
        page_number,

...
class MosaicSupplyChangeTransactionDTO(BaseModel):
    """
    ...
    delta: StrictStr = Field(description="Absolute amount. An amount of 123456789 (absolute) for a mosaic with divisibility 6 means 123.456789 (relative).")
    action: MosaicSupplyChangeActionEnum
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "mosaicId", "delta", "action"]

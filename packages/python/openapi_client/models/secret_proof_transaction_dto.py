...
class SecretProofTransactionDTO(BaseModel):
    """
    ...
    proof: StrictStr = Field(description="Original random set of bytes.")
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "recipientAddress", "secret", "hashAlgorithm", "proof"]

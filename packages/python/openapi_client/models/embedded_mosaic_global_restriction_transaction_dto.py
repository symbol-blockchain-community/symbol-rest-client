...
class EmbeddedMosaicGlobalRestrictionTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "mosaicId", "referenceMosaicId", "restrictionKey", "previousRestrictionValue", "newRestrictionValue", "previousRestrictionType", "newRestrictionType"]

...
class TransactionStatementPage(BaseModel):
    """
    TransactionStatementPage
    """ # noqa: E501
    data: List[TransactionStatementInfoDTO] = Field(description="Array of transaction statements.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TransactionStatementInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

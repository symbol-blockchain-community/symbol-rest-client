...
class TransactionPage(BaseModel):
    ...
    TransactionPage
    """ # noqa: E501
    data: List[TransactionInfoDTO] = Field(description="Array of transactions.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TransactionInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

...
class NamespaceMetadataTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "targetAddress", "scopedMetadataKey", "targetNamespaceId", "valueSizeDelta", "valueSize", "value"]

...
class AccountMetadataTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "targetAddress", "scopedMetadataKey", "valueSizeDelta", "valueSize", "value"]

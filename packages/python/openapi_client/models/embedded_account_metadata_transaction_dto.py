...
class EmbeddedAccountMetadataTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "targetAddress", "scopedMetadataKey", "valueSizeDelta", "valueSize", "value"]

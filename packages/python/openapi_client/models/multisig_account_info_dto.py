...
class MultisigAccountInfoDTO(BaseModel):
    """
    MultisigAccountInfoDTO
    """ # noqa: E501
    multisig: MultisigDTO
    __properties: ClassVar[List[str]] = ["multisig"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "multisig": MultisigDTO.from_dict(obj.get("multisig")) if obj.get("multisig") is not None else None
        })
        return _obj

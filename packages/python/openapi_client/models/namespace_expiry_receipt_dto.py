...
class NamespaceExpiryReceiptDTO(BaseModel):
    """
    Receipt stored when a namespace expires.
    """ # noqa: E501
    version: StrictInt = Field(description="Version of the receipt.")
    type: ReceiptTypeEnum
    artifact_id: StrictStr = Field(description="Namespace identifier.", alias="artifactId")
    __properties: ClassVar[List[str]] = ["version", "type", "artifactId"]

...
class MessageGroup(BaseModel):
    ...
    hashes: List[StrictStr]
    signatures: List[BmTreeSignature]
    __properties: ClassVar[List[str]] = ["stage", "height", "hashes", "signatures"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "signatures": [BmTreeSignature.from_dict(_item) for _item in obj.get("signatures")] if obj.get("signatures") is not None else None
        })
        return _obj

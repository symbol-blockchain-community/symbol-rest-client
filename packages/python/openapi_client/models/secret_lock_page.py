...
class SecretLockPage(BaseModel):
    """
    SecretLockPage
    """ # noqa: E501
    data: List[SecretLockInfoDTO] = Field(description="Array of secret locks.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SecretLockInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

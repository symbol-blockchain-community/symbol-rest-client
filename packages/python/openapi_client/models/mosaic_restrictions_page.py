...
class MosaicRestrictionsPage(BaseModel):
    """
    MosaicRestrictionsPage
    """ # noqa: E501
    data: List[MosaicRestrictionsPageDataInner] = Field(description="Array of mosaic restrictions.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [MosaicRestrictionsPageDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

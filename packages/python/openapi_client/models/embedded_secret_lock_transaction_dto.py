...
class EmbeddedSecretLockTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "recipientAddress", "secret", "mosaicId", "amount", "duration", "hashAlgorithm"]

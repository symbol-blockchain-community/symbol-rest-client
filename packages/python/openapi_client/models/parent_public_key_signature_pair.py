...
class ParentPublicKeySignaturePair(BaseModel):
    """
    ParentPublicKeySignaturePair
    """ # noqa: E501
    parent_public_key: StrictStr = Field(description="Public key.", alias="parentPublicKey")
    signature: StrictStr = Field(description="Entity's signature generated by the signer.")
    __properties: ClassVar[List[str]] = ["parentPublicKey", "signature"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "parentPublicKey": obj.get("parentPublicKey"),

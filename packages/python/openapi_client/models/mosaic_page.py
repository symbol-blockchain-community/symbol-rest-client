...
class MosaicPage(BaseModel):
    """
    MosaicPage
    """ # noqa: E501
    data: List[MosaicInfoDTO] = Field(description="Array of mosaics.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [MosaicInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

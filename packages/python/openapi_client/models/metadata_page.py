...
class MetadataPage(BaseModel):
    ...
    MetadataPage
    """ # noqa: E501
    data: List[MetadataInfoDTO] = Field(description="Array of metadata entries.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [MetadataInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

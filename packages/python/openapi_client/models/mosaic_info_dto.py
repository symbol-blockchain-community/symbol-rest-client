...
class MosaicInfoDTO(BaseModel):
    """
    MosaicInfoDTO
    """ # noqa: E501
    id: StrictStr = Field(description="Internal resource identifier.")
    mosaic: MosaicDTO
    __properties: ClassVar[List[str]] = ["id", "mosaic"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "mosaic": MosaicDTO.from_dict(obj.get("mosaic")) if obj.get("mosaic") is not None else None
        })
        return _obj

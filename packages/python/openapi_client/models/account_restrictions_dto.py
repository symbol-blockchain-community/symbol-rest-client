...
class AccountRestrictionsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["version", "address", "restrictions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": [AccountRestrictionDTO.from_dict(_item) for _item in obj.get("restrictions")] if obj.get("restrictions") is not None else None
        })
        return _obj

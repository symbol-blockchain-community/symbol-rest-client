...
class EmbeddedMosaicAddressRestrictionTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "mosaicId", "restrictionKey", "previousRestrictionValue", "newRestrictionValue", "targetAddress"]

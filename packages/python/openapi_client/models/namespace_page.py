...
class NamespacePage(BaseModel):
    ...
    NamespacePage
    """ # noqa: E501
    data: List[NamespaceInfoDTO] = Field(description="Array of namespaces.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [NamespaceInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

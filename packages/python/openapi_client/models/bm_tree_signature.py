...
class BmTreeSignature(BaseModel):
    """
    BmTreeSignature
    """ # noqa: E501
    root: ParentPublicKeySignaturePair
    bottom: ParentPublicKeySignaturePair
    __properties: ClassVar[List[str]] = ["root", "bottom"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "root": ParentPublicKeySignaturePair.from_dict(obj.get("root")) if obj.get("root") is not None else None,
            "bottom": ParentPublicKeySignaturePair.from_dict(obj.get("bottom")) if obj.get("bottom") is not None else None
        })
        return _obj

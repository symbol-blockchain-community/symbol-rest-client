...
class EmbeddedTransactionInfoDTO(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": EmbeddedTransactionMetaDTO.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "transaction": EmbeddedTransactionInfoDTOTransaction.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj

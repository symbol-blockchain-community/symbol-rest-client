...
class SecretLockTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "recipientAddress", "secret", "mosaicId", "amount", "duration", "hashAlgorithm"]

...
class AccountPage(BaseModel):
    ...
    AccountPage
    """ # noqa: E501
    data: List[AccountInfoDTO] = Field(description="Array of accounts.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [AccountInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

...
class EmbeddedNamespaceRegistrationTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "duration", "parentId", "id", "registrationType", "name"]

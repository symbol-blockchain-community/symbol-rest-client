...
class SecretLockInfoDTO(BaseModel):
    """
    SecretLockInfoDTO
    """ # noqa: E501
    id: StrictStr
    lock: SecretLockEntryDTO
    __properties: ClassVar[List[str]] = ["id", "lock"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "lock": SecretLockEntryDTO.from_dict(obj.get("lock")) if obj.get("lock") is not None else None
        })
        return _obj

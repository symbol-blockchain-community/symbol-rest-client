...
class BlockInfoDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "meta", "block"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": BlockMetaDTO.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "block": BlockInfoDTOBlock.from_dict(obj.get("block")) if obj.get("block") is not None else None
        })
        return _obj

...
class MosaicGlobalRestrictionEntryWrapperDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["version", "compositeHash", "entryType", "mosaicId", "restrictions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": [MosaicGlobalRestrictionEntryDTO.from_dict(_item) for _item in obj.get("restrictions")] if obj.get("restrictions") is not None else None
        })
        return _obj

...
class AggregateTransactionExtendedDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "transactionsHash", "cosignatures", "transactions"]

...
class MosaicAddressRestrictionTransactionBodyDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mosaicId", "restrictionKey", "previousRestrictionValue", "newRestrictionValue", "targetAddress"]

...
class AccountKeyLinkNetworkPropertiesDTO(BaseModel):
    """
    AccountKeyLinkNetworkPropertiesDTO
    """ # noqa: E501
    dummy: Optional[StrictStr] = Field(default=None, description="to trigger plugin load")
    __properties: ClassVar[List[str]] = ["dummy"]

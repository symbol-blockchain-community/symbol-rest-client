...
class BlockPage(BaseModel):
    ...
    BlockPage
    """ # noqa: E501
    data: List[BlockInfoDTO] = Field(description="Array of blocks.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [BlockInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

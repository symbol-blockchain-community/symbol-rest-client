...
class MosaicDefinitionTransactionDTO(BaseModel):
    """
    ...
    nonce: StrictInt = Field(description="A number that allows uint 32 values.")
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "id", "duration", "nonce", "flags", "divisibility"]

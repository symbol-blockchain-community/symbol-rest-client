...
class AccountOperationRestrictionTransactionDTO(BaseModel):
    """
    ...
    restriction_flags: AccountRestrictionFlagsEnum = Field(alias="restrictionFlags")
    restriction_additions: List[TransactionTypeEnum] = Field(description="Account restriction additions.", alias="restrictionAdditions")
    restriction_deletions: List[TransactionTypeEnum] = Field(description="Account restriction deletions.", alias="restrictionDeletions")
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "restrictionFlags", "restrictionAdditions", "restrictionDeletions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "restrictionFlags": obj.get("restrictionFlags"),
            "restrictionAdditions": obj.get("restrictionAdditions"),
            "restrictionDeletions": obj.get("restrictionDeletions")
        })
        return _obj

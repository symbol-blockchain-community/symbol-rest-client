...
class AccountRestrictionsPage(BaseModel):
    """
    AccountRestrictionsPage
    """ # noqa: E501
    data: List[AccountRestrictionsInfoDTO] = Field(description="Array of account restrictions.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [AccountRestrictionsInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

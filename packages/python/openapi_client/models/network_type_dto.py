...
class NetworkTypeDTO(BaseModel):
    """
    NetworkTypeDTO
    """ # noqa: E501
    name: StrictStr = Field(description="Network name.")
    description: StrictStr = Field(description="A short text describing the network.")

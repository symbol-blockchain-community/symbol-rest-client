...
class TransactionStatusEnum(str, Enum):
    ...
    FAILURE_ACCOUNT_LINK_LINK_ALREADY_EXISTS = 'Failure_AccountLink_Link_Already_Exists'
    FAILURE_ACCOUNT_LINK_INCONSISTENT_UNLINK_DATA = 'Failure_AccountLink_Inconsistent_Unlink_Data'
    FAILURE_ACCOUNT_LINK_UNKNOWN_LINK = 'Failure_AccountLink_Unknown_Link'
    FAILURE_ACCOUNT_LINK_REMOTE_ACCOUNT_INELIGIBLE = 'Failure_AccountLink_Remote_Account_Ineligible'
    FAILURE_ACCOUNT_LINK_REMOTE_ACCOUNT_SIGNER_PROHIBITED = 'Failure_AccountLink_Remote_Account_Signer_Prohibited'
    FAILURE_ACCOUNT_LINK_REMOTE_ACCOUNT_PARTICIPANT_PROHIBITED = 'Failure_AccountLink_Remote_Account_Participant_Prohibited'
    ...
    FAILURE_LOCK_HASH_INVALID_MOSAIC_ID = 'Failure_LockHash_Invalid_Mosaic_Id'
    FAILURE_LOCK_HASH_INVALID_MOSAIC_AMOUNT = 'Failure_LockHash_Invalid_Mosaic_Amount'
    FAILURE_LOCK_HASH_HASH_ALREADY_EXISTS = 'Failure_LockHash_Hash_Already_Exists'
    FAILURE_LOCK_HASH_UNKNOWN_HASH = 'Failure_LockHash_Unknown_Hash'
    FAILURE_LOCK_HASH_INACTIVE_HASH = 'Failure_LockHash_Inactive_Hash'
    FAILURE_LOCK_HASH_INVALID_DURATION = 'Failure_LockHash_Invalid_Duration'
    FAILURE_LOCK_SECRET_INVALID_HASH_ALGORITHM = 'Failure_LockSecret_Invalid_Hash_Algorithm'
    FAILURE_LOCK_SECRET_HASH_ALREADY_EXISTS = 'Failure_LockSecret_Hash_Already_Exists'
    FAILURE_LOCK_SECRET_PROOF_SIZE_OUT_OF_BOUNDS = 'Failure_LockSecret_Proof_Size_Out_Of_Bounds'
    FAILURE_LOCK_SECRET_SECRET_MISMATCH = 'Failure_LockSecret_Secret_Mismatch'
    FAILURE_LOCK_SECRET_UNKNOWN_COMPOSITE_KEY = 'Failure_LockSecret_Unknown_Composite_Key'
    FAILURE_LOCK_SECRET_INACTIVE_SECRET = 'Failure_LockSecret_Inactive_Secret'
    FAILURE_LOCK_SECRET_HASH_ALGORITHM_MISMATCH = 'Failure_LockSecret_Hash_Algorithm_Mismatch'
    FAILURE_LOCK_SECRET_INVALID_DURATION = 'Failure_LockSecret_Invalid_Duration'
    ...
    FAILURE_RESTRICTION_ACCOUNT_INVALID_RESTRICTION_FLAGS = 'Failure_RestrictionAccount_Invalid_Restriction_Flags'
    FAILURE_RESTRICTION_ACCOUNT_INVALID_MODIFICATION_ACTION = 'Failure_RestrictionAccount_Invalid_Modification_Action'
    FAILURE_RESTRICTION_ACCOUNT_INVALID_MODIFICATION_ADDRESS = 'Failure_RestrictionAccount_Invalid_Modification_Address'
    FAILURE_RESTRICTION_ACCOUNT_MODIFICATION_OPERATION_TYPE_INCOMPATIBLE = 'Failure_RestrictionAccount_Modification_Operation_Type_Incompatible'
    FAILURE_RESTRICTION_ACCOUNT_REDUNDANT_MODIFICATION = 'Failure_RestrictionAccount_Redundant_Modification'
    FAILURE_RESTRICTION_ACCOUNT_INVALID_MODIFICATION = 'Failure_RestrictionAccount_Invalid_Modification'
    FAILURE_RESTRICTION_ACCOUNT_MODIFICATION_COUNT_EXCEEDED = 'Failure_RestrictionAccount_Modification_Count_Exceeded'
    FAILURE_RESTRICTION_ACCOUNT_NO_MODIFICATIONS = 'Failure_RestrictionAccount_No_Modifications'
    FAILURE_RESTRICTION_ACCOUNT_VALUES_COUNT_EXCEEDED = 'Failure_RestrictionAccount_Values_Count_Exceeded'
    FAILURE_RESTRICTION_ACCOUNT_INVALID_VALUE = 'Failure_RestrictionAccount_Invalid_Value'
    FAILURE_RESTRICTION_ACCOUNT_ADDRESS_INTERACTION_PROHIBITED = 'Failure_RestrictionAccount_Address_Interaction_Prohibited'
    FAILURE_RESTRICTION_ACCOUNT_MOSAIC_TRANSFER_PROHIBITED = 'Failure_RestrictionAccount_Mosaic_Transfer_Prohibited'
    FAILURE_RESTRICTION_ACCOUNT_OPERATION_TYPE_PROHIBITED = 'Failure_RestrictionAccount_Operation_Type_Prohibited'
    FAILURE_RESTRICTION_MOSAIC_INVALID_RESTRICTION_TYPE = 'Failure_RestrictionMosaic_Invalid_Restriction_Type'
    FAILURE_RESTRICTION_MOSAIC_PREVIOUS_VALUE_MISMATCH = 'Failure_RestrictionMosaic_Previous_Value_Mismatch'
    FAILURE_RESTRICTION_MOSAIC_PREVIOUS_VALUE_MUST_BE_ZERO = 'Failure_RestrictionMosaic_Previous_Value_Must_Be_Zero'
    FAILURE_RESTRICTION_MOSAIC_MAX_RESTRICTIONS_EXCEEDED = 'Failure_RestrictionMosaic_Max_Restrictions_Exceeded'
    FAILURE_RESTRICTION_MOSAIC_CANNOT_DELETE_NONEXISTENT_RESTRICTION = 'Failure_RestrictionMosaic_Cannot_Delete_Nonexistent_Restriction'
    FAILURE_RESTRICTION_MOSAIC_UNKNOWN_GLOBAL_RESTRICTION = 'Failure_RestrictionMosaic_Unknown_Global_Restriction'
    FAILURE_RESTRICTION_MOSAIC_INVALID_GLOBAL_RESTRICTION = 'Failure_RestrictionMosaic_Invalid_Global_Restriction'
    FAILURE_RESTRICTION_MOSAIC_ACCOUNT_UNAUTHORIZED = 'Failure_RestrictionMosaic_Account_Unauthorized'

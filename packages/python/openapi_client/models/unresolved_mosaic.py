...
class UnresolvedMosaic(BaseModel):
    """
    UnresolvedMosaic
    """ # noqa: E501
    id: StrictStr = Field(description="Mosaic identifier. If the most significant bit of byte 0 is set, a namespaceId (alias) is used instead of the real mosaic identifier. ")

...
class FinalizationProofDTO(BaseModel):
    """
    ...
    hash: StrictStr
    message_groups: List[MessageGroup] = Field(alias="messageGroups")
    __properties: ClassVar[List[str]] = ["version", "finalizationEpoch", "finalizationPoint", "height", "hash", "messageGroups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in message_groups (list)
        _items = []
        if self.message_groups:
            for _item in self.message_groups:
                if _item:
                    _items.append(_item.to_dict())
            _dict['messageGroups'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hash": obj.get("hash"),
            "messageGroups": [MessageGroup.from_dict(_item) for _item in obj.get("messageGroups")] if obj.get("messageGroups") is not None else None
        })
        return _obj

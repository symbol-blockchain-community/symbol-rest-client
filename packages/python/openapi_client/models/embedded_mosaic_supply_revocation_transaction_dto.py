...
class EmbeddedMosaicSupplyRevocationTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signerPublicKey", "version", "network", "type", "sourceAddress", "mosaicId", "amount"]

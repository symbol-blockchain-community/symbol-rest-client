...
class AccountAddressRestrictionTransactionDTO(BaseModel):
    """
    ...
    restriction_additions: List[StrictStr] = Field(description="Account restriction additions.", alias="restrictionAdditions")
    restriction_deletions: List[StrictStr] = Field(description="Account restriction deletions.", alias="restrictionDeletions")

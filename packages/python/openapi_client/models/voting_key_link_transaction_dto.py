...
class VotingKeyLinkTransactionDTO(BaseModel):
    """
    ...
    linked_public_key: StrictStr = Field(description="32 bytes voting public key.", alias="linkedPublicKey")
    start_epoch: StrictInt = Field(description="Finalization Epoch", alias="startEpoch")
    end_epoch: StrictInt = Field(description="Finalization Epoch", alias="endEpoch")
    link_action: LinkActionEnum = Field(alias="linkAction")
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "linkedPublicKey", "startEpoch", "endEpoch", "linkAction"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "startEpoch": obj.get("startEpoch"),
            "endEpoch": obj.get("endEpoch"),

...
class AccountsNamesDTO(BaseModel):
    """
    AccountsNamesDTO
    """ # noqa: E501
    account_names: List[AccountNamesDTO] = Field(description="Array of account names.", alias="accountNames")
    __properties: ClassVar[List[str]] = ["accountNames"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "accountNames": [AccountNamesDTO.from_dict(_item) for _item in obj.get("accountNames")] if obj.get("accountNames") is not None else None
        })
        return _obj

...
class ResolutionStatementPage(BaseModel):
    """
    ResolutionStatementPage
    """ # noqa: E501
    data: List[ResolutionStatementInfoDTO] = Field(description="Array of transaction address resolution statements.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ResolutionStatementInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

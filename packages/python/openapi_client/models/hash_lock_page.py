...
class HashLockPage(BaseModel):
    """
    HashLockPage
    """ # noqa: E501
    data: List[HashLockInfoDTO] = Field(description="Array of hash locks.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [HashLockInfoDTO.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,

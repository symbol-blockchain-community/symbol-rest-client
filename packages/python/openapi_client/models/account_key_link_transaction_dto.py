...
class AccountKeyLinkTransactionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "signature", "signerPublicKey", "version", "network", "type", "maxFee", "deadline", "linkedPublicKey", "linkAction"]

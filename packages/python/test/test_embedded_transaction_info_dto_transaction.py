...
class TestEmbeddedTransactionInfoDTOTransaction(unittest.TestCase):
    """EmbeddedTransactionInfoDTOTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmbeddedTransactionInfoDTOTransaction:
        """Test EmbeddedTransactionInfoDTOTransaction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmbeddedTransactionInfoDTOTransaction`
        """
        model = EmbeddedTransactionInfoDTOTransaction()
        if include_optional:
    ...
    def testEmbeddedTransactionInfoDTOTransaction(self):
        """Test EmbeddedTransactionInfoDTOTransaction"""

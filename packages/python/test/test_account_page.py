...
class TestAccountPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountPage:
        """Test AccountPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountPage`
        """
        model = AccountPage()
        if include_optional:
            return AccountPage(
                data = [
                    openapi_client.models.account_info_dto.AccountInfoDTO(
                        id = '', 

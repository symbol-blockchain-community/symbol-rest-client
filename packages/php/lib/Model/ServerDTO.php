 ...
 */
class ServerDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'rest_version' => 'string',
        'sdk_version' => 'string',
        'deployment' => '\SymbolRestClient\Model\DeploymentDTO'
    ];
    ...
    {
        $this->setIfExists('rest_version', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($rest_version)) {
            throw new \InvalidArgumentException('non-nullable rest_version cannot be null');
        }
     ...
     * Gets deployment
     *
     * @return \SymbolRestClient\Model\DeploymentDTO
     */
     ...
     * Sets deployment
     *
     * @param \SymbolRestClient\Model\DeploymentDTO $deployment deployment
     *
     * @return self
     */

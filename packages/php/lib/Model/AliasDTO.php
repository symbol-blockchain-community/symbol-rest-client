...
class AliasDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\SymbolRestClient\Model\AliasTypeEnum',
        'mosaic_id' => 'string',
        'address' => 'string'
    ];
    ...
    */
     ...
     * Gets type
     *
     * @return \SymbolRestClient\Model\AliasTypeEnum
     */
     ...
     * Sets type
     *
     * @param \SymbolRestClient\Model\AliasTypeEnum $type type
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address Address encoded using a 32-character set.
     *
     * @return self
     */

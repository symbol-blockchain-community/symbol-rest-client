//
// MosaicGlobalRestrictionTransactionBodyDTO.swift
//
...
public struct MosaicGlobalRestrictionTransactionBodyDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(mosaicId: String, referenceMosaicId: String, restrictionKey: String, previousRestrictionValue: String, newRestrictionValue: String, previousRestrictionType: MosaicRestrictionTypeEnum, newRestrictionType: MosaicRestrictionTypeEnum) {

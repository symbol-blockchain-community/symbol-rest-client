//
// AccountOperationRestrictionTransactionDTO.swift
//
...
public struct AccountOperationRestrictionTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(size: Int64, signature: String, signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, maxFee: String, deadline: String, restrictionFlags: AccountRestrictionFlagsEnum, restrictionAdditions: [TransactionTypeEnum], restrictionDeletions: [TransactionTypeEnum]) {
        self.size = size

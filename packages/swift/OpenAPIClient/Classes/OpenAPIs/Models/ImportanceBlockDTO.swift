...
public struct ImportanceBlockDTO: Codable, JSONEncodable, Hashable {
    ...
    /** A number that allows uint 32 values. */
    public var votingEligibleAccountsCount: Int64
    /** A number that allows uint 64 values represented with a string. */
    public var harvestingEligibleAccountsCount: String
    /** Absolute amount. An amount of 123456789 (absolute) for a mosaic with divisibility 6 means 123.456789 (relative). */
    public var totalVotingBalance: String
    public var previousImportanceBlockHash: String

    public init(size: Int64, signature: String, signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, height: String, timestamp: String, difficulty: String, proofGamma: String, proofVerificationHash: String, proofScalar: String, previousBlockHash: String, transactionsHash: String, receiptsHash: String, stateHash: String, beneficiaryAddress: String, feeMultiplier: Int64, votingEligibleAccountsCount: Int64, harvestingEligibleAccountsCount: String, totalVotingBalance: String, previousImportanceBlockHash: String) {
        self.size = size
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case feeMultiplier
        case votingEligibleAccountsCount
        case harvestingEligibleAccountsCount
        case totalVotingBalance
        case previousImportanceBlockHash
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(votingEligibleAccountsCount, forKey: .votingEligibleAccountsCount)
        try container.encode(harvestingEligibleAccountsCount, forKey: .harvestingEligibleAccountsCount)
        try container.encode(totalVotingBalance, forKey: .totalVotingBalance)
        try container.encode(previousImportanceBlockHash, forKey: .previousImportanceBlockHash)
    }
}

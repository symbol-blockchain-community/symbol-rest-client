//
// EmbeddedNamespaceMetadataTransactionDTO.swift
//
...
public struct EmbeddedNamespaceMetadataTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, targetAddress: String, scopedMetadataKey: String, targetNamespaceId: String? = nil, valueSizeDelta: Int, valueSize: Int64, value: String) {

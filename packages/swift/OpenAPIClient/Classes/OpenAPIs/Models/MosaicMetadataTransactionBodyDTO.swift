//
// MosaicMetadataTransactionBodyDTO.swift
//
...
public struct MosaicMetadataTransactionBodyDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(targetAddress: String, scopedMetadataKey: String, targetMosaicId: String, valueSizeDelta: Int, valueSize: Int64, value: String) {

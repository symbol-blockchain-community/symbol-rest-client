//
// EmbeddedAccountOperationRestrictionTransactionDTO.swift
//
...
public struct EmbeddedAccountOperationRestrictionTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, restrictionFlags: AccountRestrictionFlagsEnum, restrictionAdditions: [TransactionTypeEnum], restrictionDeletions: [TransactionTypeEnum]) {

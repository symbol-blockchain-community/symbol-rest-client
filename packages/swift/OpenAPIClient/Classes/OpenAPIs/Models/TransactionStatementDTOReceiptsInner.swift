//
// TransactionStatementDTOReceiptsInner.swift
//
...
public struct TransactionStatementDTOReceiptsInner: Codable, JSONEncodable, Hashable {
    ...
    public init(version: Int, type: ReceiptTypeEnum, mosaicId: String, amount: String, senderAddress: String, recipientAddress: String, targetAddress: String, artifactId: String) {

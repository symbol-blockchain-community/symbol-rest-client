//
// EmbeddedMosaicMetadataTransactionDTO.swift
//
...
public struct EmbeddedMosaicMetadataTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, targetAddress: String, scopedMetadataKey: String, targetMosaicId: String, valueSizeDelta: Int, valueSize: Int64, value: String) {

//
// MosaicAddressRestrictionTransactionBodyDTO.swift
//
...
public struct MosaicAddressRestrictionTransactionBodyDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(mosaicId: String, restrictionKey: String, previousRestrictionValue: String, newRestrictionValue: String, targetAddress: String) {

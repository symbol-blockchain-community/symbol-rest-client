//
// AccountMetadataTransactionBodyDTO.swift
//
...
public struct AccountMetadataTransactionBodyDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(targetAddress: String, scopedMetadataKey: String, valueSizeDelta: Int, valueSize: Int64, value: String) {

//
// EmbeddedMosaicSupplyRevocationTransactionDTO.swift
//
...
public struct EmbeddedMosaicSupplyRevocationTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, sourceAddress: String, mosaicId: String, amount: String) {

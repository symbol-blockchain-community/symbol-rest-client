//
// AddressAliasTransactionDTO.swift
//
...
public struct AddressAliasTransactionDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(size: Int64, signature: String, signerPublicKey: String, version: Int, network: NetworkTypeEnum, type: Int, maxFee: String, deadline: String, namespaceId: String, address: String, aliasAction: AliasActionEnum) {
        self.size = size

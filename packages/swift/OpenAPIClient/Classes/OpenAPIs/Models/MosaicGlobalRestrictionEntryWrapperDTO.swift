//
// MosaicGlobalRestrictionEntryWrapperDTO.swift
//
...
public struct MosaicGlobalRestrictionEntryWrapperDTO: Codable, JSONEncodable, Hashable {
    ...
    public var restrictions: [MosaicGlobalRestrictionEntryDTO]

    public init(version: Int, compositeHash: String, entryType: MosaicRestrictionEntryTypeEnum, mosaicId: String, restrictions: [MosaicGlobalRestrictionEntryDTO]) {

...
// checks if the MosaicAliasTransactionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MosaicAliasTransactionDTO{}

// MosaicAliasTransactionDTO Transaction to link a namespace to a mosaic.
...
type _MosaicAliasTransactionDTO MosaicAliasTransactionDTO
...
func NewMosaicAliasTransactionDTO(size int64, signature string, signerPublicKey string, version int32, network NetworkTypeEnum, type_ int32, maxFee string, deadline string, namespaceId string, mosaicId string, aliasAction AliasActionEnum) *MosaicAliasTransactionDTO {
	this := MosaicAliasTransactionDTO{}
	this.Size = size
...
func (o MosaicAliasTransactionDTO) MarshalJSON() ([]byte, error) {
...
func (o MosaicAliasTransactionDTO) ToMap() (map[string]interface{}, error) {
...
func (o *MosaicAliasTransactionDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varMosaicAliasTransactionDTO := _MosaicAliasTransactionDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMosaicAliasTransactionDTO)

	if err != nil {
		return err
	}

	*o = MosaicAliasTransactionDTO(varMosaicAliasTransactionDTO)

	return err
}

type NullableMosaicAliasTransactionDTO struct {
	value *MosaicAliasTransactionDTO
	isSet bool
}

func (v NullableMosaicAliasTransactionDTO) Get() *MosaicAliasTransactionDTO {
	return v.value
}

func (v *NullableMosaicAliasTransactionDTO) Set(val *MosaicAliasTransactionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableMosaicAliasTransactionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableMosaicAliasTransactionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMosaicAliasTransactionDTO(val *MosaicAliasTransactionDTO) *NullableMosaicAliasTransactionDTO {
	return &NullableMosaicAliasTransactionDTO{value: val, isSet: true}
}

func (v NullableMosaicAliasTransactionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMosaicAliasTransactionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true

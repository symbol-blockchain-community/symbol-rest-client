...
// checks if the VrfKeyLinkTransactionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VrfKeyLinkTransactionDTO{}

// VrfKeyLinkTransactionDTO Transaction to link an account with a VRF public key. The key is used to randomize block production and leader/participant selection. Required for all harvesting eligible accounts. 
...
type _VrfKeyLinkTransactionDTO VrfKeyLinkTransactionDTO
...
func (o VrfKeyLinkTransactionDTO) MarshalJSON() ([]byte, error) {
...
func (o VrfKeyLinkTransactionDTO) ToMap() (map[string]interface{}, error) {
...
func (o *VrfKeyLinkTransactionDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varVrfKeyLinkTransactionDTO := _VrfKeyLinkTransactionDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVrfKeyLinkTransactionDTO)

	if err != nil {
		return err
	}

	*o = VrfKeyLinkTransactionDTO(varVrfKeyLinkTransactionDTO)

	return err
}

type NullableVrfKeyLinkTransactionDTO struct {
	value *VrfKeyLinkTransactionDTO
	isSet bool
}

func (v NullableVrfKeyLinkTransactionDTO) Get() *VrfKeyLinkTransactionDTO {
	return v.value
}

func (v *NullableVrfKeyLinkTransactionDTO) Set(val *VrfKeyLinkTransactionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableVrfKeyLinkTransactionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableVrfKeyLinkTransactionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVrfKeyLinkTransactionDTO(val *VrfKeyLinkTransactionDTO) *NullableVrfKeyLinkTransactionDTO {
	return &NullableVrfKeyLinkTransactionDTO{value: val, isSet: true}
}

func (v NullableVrfKeyLinkTransactionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVrfKeyLinkTransactionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EmbeddedVrfKeyLinkTransactionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedVrfKeyLinkTransactionDTO{}

// EmbeddedVrfKeyLinkTransactionDTO struct for EmbeddedVrfKeyLinkTransactionDTO
type EmbeddedVrfKeyLinkTransactionDTO struct {
	// Public key.
...
type _EmbeddedVrfKeyLinkTransactionDTO EmbeddedVrfKeyLinkTransactionDTO
...
func NewEmbeddedVrfKeyLinkTransactionDTO(signerPublicKey string, version int32, network NetworkTypeEnum, type_ int32, linkedPublicKey string, linkAction LinkActionEnum) *EmbeddedVrfKeyLinkTransactionDTO {
	this := EmbeddedVrfKeyLinkTransactionDTO{}
...
func (o EmbeddedVrfKeyLinkTransactionDTO) MarshalJSON() ([]byte, error) {
...
func (o EmbeddedVrfKeyLinkTransactionDTO) ToMap() (map[string]interface{}, error) {
...
func (o *EmbeddedVrfKeyLinkTransactionDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varEmbeddedVrfKeyLinkTransactionDTO := _EmbeddedVrfKeyLinkTransactionDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmbeddedVrfKeyLinkTransactionDTO)

	if err != nil {
		return err
	}

	*o = EmbeddedVrfKeyLinkTransactionDTO(varEmbeddedVrfKeyLinkTransactionDTO)

	return err
}

type NullableEmbeddedVrfKeyLinkTransactionDTO struct {
	value *EmbeddedVrfKeyLinkTransactionDTO
	isSet bool
}

func (v NullableEmbeddedVrfKeyLinkTransactionDTO) Get() *EmbeddedVrfKeyLinkTransactionDTO {
	return v.value
}

func (v *NullableEmbeddedVrfKeyLinkTransactionDTO) Set(val *EmbeddedVrfKeyLinkTransactionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableEmbeddedVrfKeyLinkTransactionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableEmbeddedVrfKeyLinkTransactionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmbeddedVrfKeyLinkTransactionDTO(val *EmbeddedVrfKeyLinkTransactionDTO) *NullableEmbeddedVrfKeyLinkTransactionDTO {
	return &NullableEmbeddedVrfKeyLinkTransactionDTO{value: val, isSet: true}
}

func (v NullableEmbeddedVrfKeyLinkTransactionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmbeddedVrfKeyLinkTransactionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true

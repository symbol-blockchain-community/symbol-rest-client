...
// checks if the HashLockTransactionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HashLockTransactionDTO{}

// HashLockTransactionDTO Transaction to lock funds before sending an aggregate bonded transaction.
type HashLockTransactionDTO struct {
...
type _HashLockTransactionDTO HashLockTransactionDTO
...
func (o HashLockTransactionDTO) MarshalJSON() ([]byte, error) {
...
func (o HashLockTransactionDTO) ToMap() (map[string]interface{}, error) {
...
func (o *HashLockTransactionDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varHashLockTransactionDTO := _HashLockTransactionDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHashLockTransactionDTO)

	if err != nil {
		return err
	}

	*o = HashLockTransactionDTO(varHashLockTransactionDTO)

	return err
}

type NullableHashLockTransactionDTO struct {
	value *HashLockTransactionDTO
	isSet bool
}

func (v NullableHashLockTransactionDTO) Get() *HashLockTransactionDTO {
	return v.value
}

func (v *NullableHashLockTransactionDTO) Set(val *HashLockTransactionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableHashLockTransactionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableHashLockTransactionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHashLockTransactionDTO(val *HashLockTransactionDTO) *NullableHashLockTransactionDTO {
	return &NullableHashLockTransactionDTO{value: val, isSet: true}
}

func (v NullableHashLockTransactionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHashLockTransactionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true

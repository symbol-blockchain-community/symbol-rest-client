...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferTransactionBodyDTO")]
    public partial class TransferTransactionBodyDTO : IValidatableObject
    {
        /// <summary>
        ...
        public TransferTransactionBodyDTO(string recipientAddress = default(string), List<UnresolvedMosaic> mosaics = default(List<UnresolvedMosaic>), string message = default(string))
        {
            ...
            {
                throw new ArgumentNullException("recipientAddress is a required property for TransferTransactionBodyDTO and cannot be null");
            }
            this.RecipientAddress = recipientAddress;
            // to ensure "mosaics" is required (not null)
            if (mosaics == null)
            {
                throw new ArgumentNullException("mosaics is a required property for TransferTransactionBodyDTO and cannot be null");
            }

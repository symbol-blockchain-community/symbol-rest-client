...
namespace Org.OpenAPITools.Model
{
    ...
    /// NodeHealthInfoDTO
    /// </summary>
    [DataContract(Name = "NodeHealthInfoDTO")]
    public partial class NodeHealthInfoDTO : IValidatableObject
    {
        /// <summary>
        ...
        public NodeHealthInfoDTO(NodeHealthDTO status = default(NodeHealthDTO))
        {
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for NodeHealthInfoDTO and cannot be null");
            }
            this.Status = status;
        }

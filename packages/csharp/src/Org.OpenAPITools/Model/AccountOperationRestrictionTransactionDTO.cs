...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountOperationRestrictionTransactionDTO")]
    public partial class AccountOperationRestrictionTransactionDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountOperationRestrictionTransactionDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountOperationRestrictionTransactionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountOperationRestrictionTransactionDTO" /> class.
        /// </summary>
        ...
        public AccountOperationRestrictionTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<TransactionTypeEnum> restrictionAdditions = default(List<TransactionTypeEnum>), List<TransactionTypeEnum> restrictionDeletions = default(List<TransactionTypeEnum>))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("restrictionAdditions is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }
            this.RestrictionAdditions = restrictionAdditions;
            // to ensure "restrictionDeletions" is required (not null)
            if (restrictionDeletions == null)
            {
                throw new ArgumentNullException("restrictionDeletions is a required property for AccountOperationRestrictionTransactionDTO and cannot be null");
            }

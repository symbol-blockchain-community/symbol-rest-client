...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmbeddedNamespaceMetadataTransactionDTO")]
    public partial class EmbeddedNamespaceMetadataTransactionDTO : IValidatableObject
    {
        ...
        public EmbeddedNamespaceMetadataTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string targetAddress = default(string), string scopedMetadataKey = default(string), string targetNamespaceId = default(string), int valueSizeDelta = default(int), long valueSize = default(long), string value = default(string))
        {
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for EmbeddedNamespaceMetadataTransactionDTO and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("targetAddress is a required property for EmbeddedNamespaceMetadataTransactionDTO and cannot be null");
            }
            this.TargetAddress = targetAddress;
            // to ensure "scopedMetadataKey" is required (not null)
            if (scopedMetadataKey == null)
            {
                throw new ArgumentNullException("scopedMetadataKey is a required property for EmbeddedNamespaceMetadataTransactionDTO and cannot be null");
            }
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for EmbeddedNamespaceMetadataTransactionDTO and cannot be null");
            }
            this.Value = value;

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmbeddedVotingKeyLinkTransactionDTO")]
    public partial class EmbeddedVotingKeyLinkTransactionDTO : IValidatableObject
    {
        ...
        public EmbeddedVotingKeyLinkTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string linkedPublicKey = default(string), long startEpoch = default(long), long endEpoch = default(long), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for EmbeddedVotingKeyLinkTransactionDTO and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("linkedPublicKey is a required property for EmbeddedVotingKeyLinkTransactionDTO and cannot be null");
            }

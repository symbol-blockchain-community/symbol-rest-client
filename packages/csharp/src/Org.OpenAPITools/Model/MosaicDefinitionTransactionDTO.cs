...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MosaicDefinitionTransactionDTO")]
    public partial class MosaicDefinitionTransactionDTO : IValidatableObject
    {
        ...
        public MosaicDefinitionTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string id = default(string), string duration = default(string), long nonce = default(long), int flags = default(int), int divisibility = default(int))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }
            this.Id = id;
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new ArgumentNullException("duration is a required property for MosaicDefinitionTransactionDTO and cannot be null");
            }

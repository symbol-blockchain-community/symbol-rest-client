...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccountMosaicRestrictionTransactionDTO : IValidatableObject
    {
        ...
        public AccountMosaicRestrictionTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<string> restrictionAdditions = default(List<string>), List<string> restrictionDeletions = default(List<string>))
        {
            ...
            {
                throw new ArgumentNullException("restrictionAdditions is a required property for AccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            this.RestrictionAdditions = restrictionAdditions;
            // to ensure "restrictionDeletions" is required (not null)
            if (restrictionDeletions == null)
            {
                throw new ArgumentNullException("restrictionDeletions is a required property for AccountMosaicRestrictionTransactionDTO and cannot be null");
            }

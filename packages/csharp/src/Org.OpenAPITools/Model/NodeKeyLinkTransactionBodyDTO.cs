...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NodeKeyLinkTransactionBodyDTO")]
    public partial class NodeKeyLinkTransactionBodyDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeKeyLinkTransactionBodyDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NodeKeyLinkTransactionBodyDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeKeyLinkTransactionBodyDTO" /> class.
        /// </summary>
        /// <param name="linkedPublicKey">Public key. (required).</param>
        /// <param name="linkAction">linkAction (required).</param>
        public NodeKeyLinkTransactionBodyDTO(string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            // to ensure "linkedPublicKey" is required (not null)
            if (linkedPublicKey == null)
            {
                throw new ArgumentNullException("linkedPublicKey is a required property for NodeKeyLinkTransactionBodyDTO and cannot be null");
            }

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AggregateTransactionBodyDTO")]
    public partial class AggregateTransactionBodyDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregateTransactionBodyDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AggregateTransactionBodyDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregateTransactionBodyDTO" /> class.
        /// </summary>
        ...
        public AggregateTransactionBodyDTO(string transactionsHash = default(string), List<CosignatureDTO> cosignatures = default(List<CosignatureDTO>))
        {
            // to ensure "transactionsHash" is required (not null)
            if (transactionsHash == null)
            {
                throw new ArgumentNullException("transactionsHash is a required property for AggregateTransactionBodyDTO and cannot be null");
            }
            this.TransactionsHash = transactionsHash;
            // to ensure "cosignatures" is required (not null)
            if (cosignatures == null)
            {
                throw new ArgumentNullException("cosignatures is a required property for AggregateTransactionBodyDTO and cannot be null");
            }

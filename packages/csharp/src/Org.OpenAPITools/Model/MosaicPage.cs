...
namespace Org.OpenAPITools.Model
{
    ...
    /// MosaicPage
    /// </summary>
    [DataContract(Name = "MosaicPage")]
    public partial class MosaicPage : IValidatableObject
    {
        /// <summary>
        ...
        public MosaicPage(List<MosaicInfoDTO> data = default(List<MosaicInfoDTO>), Pagination pagination = default(Pagination))
        {
            ...
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MosaicPage and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for MosaicPage and cannot be null");
            }

...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EmbeddedVrfKeyLinkTransactionDTO : IValidatableObject
    {
        ...
        public EmbeddedVrfKeyLinkTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {

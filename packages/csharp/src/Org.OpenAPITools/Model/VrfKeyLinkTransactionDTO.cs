...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VrfKeyLinkTransactionDTO")]
    public partial class VrfKeyLinkTransactionDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VrfKeyLinkTransactionDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VrfKeyLinkTransactionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VrfKeyLinkTransactionDTO" /> class.
        /// </summary>
        ...
        public VrfKeyLinkTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for VrfKeyLinkTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for VrfKeyLinkTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for VrfKeyLinkTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for VrfKeyLinkTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "linkedPublicKey" is required (not null)
            if (linkedPublicKey == null)
            {
                throw new ArgumentNullException("linkedPublicKey is a required property for VrfKeyLinkTransactionDTO and cannot be null");
            }

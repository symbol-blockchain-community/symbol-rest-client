...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VrfKeyLinkTransactionBodyDTO")]
    public partial class VrfKeyLinkTransactionBodyDTO : IValidatableObject
    {
        ...
        public VrfKeyLinkTransactionBodyDTO(string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            ...
            {
                throw new ArgumentNullException("linkedPublicKey is a required property for VrfKeyLinkTransactionBodyDTO and cannot be null");
            }

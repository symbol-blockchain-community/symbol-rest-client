...
namespace SymbolRestClient.Model
{
    ...
    public partial class EmbeddedAccountOperationRestrictionTransactionDTO : IValidatableObject
    {
        ...
        public EmbeddedAccountOperationRestrictionTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<TransactionTypeEnum> restrictionAdditions = default(List<TransactionTypeEnum>), List<TransactionTypeEnum> restrictionDeletions = default(List<TransactionTypeEnum>))
        {
            ...
            {
                throw new ArgumentNullException("restrictionAdditions is a required property for EmbeddedAccountOperationRestrictionTransactionDTO and cannot be null");
            }
            this.RestrictionAdditions = restrictionAdditions;
            // to ensure "restrictionDeletions" is required (not null)
            if (restrictionDeletions == null)
            {
                throw new ArgumentNullException("restrictionDeletions is a required property for EmbeddedAccountOperationRestrictionTransactionDTO and cannot be null");
            }

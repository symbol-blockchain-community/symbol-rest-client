...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MosaicMetadataTransactionDTO")]
    public partial class MosaicMetadataTransactionDTO : IValidatableObject
    {
        ...
        public MosaicMetadataTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string targetAddress = default(string), string scopedMetadataKey = default(string), string targetMosaicId = default(string), int valueSizeDelta = default(int), long valueSize = default(long), string value = default(string))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "targetAddress" is required (not null)
            if (targetAddress == null)
            {
                throw new ArgumentNullException("targetAddress is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.TargetAddress = targetAddress;
            // to ensure "scopedMetadataKey" is required (not null)
            if (scopedMetadataKey == null)
            {
                throw new ArgumentNullException("scopedMetadataKey is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.ScopedMetadataKey = scopedMetadataKey;
            // to ensure "targetMosaicId" is required (not null)
            if (targetMosaicId == null)
            {
                throw new ArgumentNullException("targetMosaicId is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MosaicMetadataTransactionDTO and cannot be null");
            }
            this.Value = value;
        }

...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountMetadataTransactionBodyDTO")]
    public partial class AccountMetadataTransactionBodyDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMetadataTransactionBodyDTO" /> class.
        /// </summary>
        [JsonConstructor]
        protected AccountMetadataTransactionBodyDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMetadataTransactionBodyDTO" /> class.
        /// </summary>
        ...
        public AccountMetadataTransactionBodyDTO(string targetAddress = default(string), string scopedMetadataKey = default(string), int valueSizeDelta = default(int), long valueSize = default(long), string value = default(string))
        {
            // to ensure "targetAddress" is required (not null)
            if (targetAddress == null)
            {
                throw new ArgumentNullException("targetAddress is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            this.TargetAddress = targetAddress;
            // to ensure "scopedMetadataKey" is required (not null)
            if (scopedMetadataKey == null)
            {
                throw new ArgumentNullException("scopedMetadataKey is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            this.Value = value;
        }

...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VotingKeyLinkTransactionDTO")]
    public partial class VotingKeyLinkTransactionDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VotingKeyLinkTransactionDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VotingKeyLinkTransactionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VotingKeyLinkTransactionDTO" /> class.
        /// </summary>
        ...
        public VotingKeyLinkTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string linkedPublicKey = default(string), long startEpoch = default(long), long endEpoch = default(long), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "linkedPublicKey" is required (not null)
            if (linkedPublicKey == null)
            {
                throw new ArgumentNullException("linkedPublicKey is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }

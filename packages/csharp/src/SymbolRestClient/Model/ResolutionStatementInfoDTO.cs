...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResolutionStatementInfoDTO")]
    public partial class ResolutionStatementInfoDTO : IValidatableObject
    {
        /// <summary>
        ...
        public ResolutionStatementInfoDTO(string id = default(string), StatementMetaDTO meta = default(StatementMetaDTO), ResolutionStatementDTO statement = default(ResolutionStatementDTO))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ResolutionStatementInfoDTO and cannot be null");
            }
            this.Id = id;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for ResolutionStatementInfoDTO and cannot be null");
            }
            this.Meta = meta;
            // to ensure "statement" is required (not null)
            if (statement == null)
            {
                throw new ArgumentNullException("statement is a required property for ResolutionStatementInfoDTO and cannot be null");
            }

...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HashLockTransactionDTO")]
    public partial class HashLockTransactionDTO : IValidatableObject
    {
        ...
        public HashLockTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string mosaicId = default(string), string amount = default(string), string duration = default(string), string hash = default(string))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for HashLockTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "mosaicId" is required (not null)
            if (mosaicId == null)
            {
                throw new ArgumentNullException("mosaicId is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.MosaicId = mosaicId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.Amount = amount;
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new ArgumentNullException("duration is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.Duration = duration;
            // to ensure "hash" is required (not null)
            if (hash == null)
            {
                throw new ArgumentNullException("hash is a required property for HashLockTransactionDTO and cannot be null");
            }
            this.Hash = hash;
        }

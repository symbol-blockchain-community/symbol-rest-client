...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MosaicSupplyRevocationTransactionDTO")]
    public partial class MosaicSupplyRevocationTransactionDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MosaicSupplyRevocationTransactionDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MosaicSupplyRevocationTransactionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MosaicSupplyRevocationTransactionDTO" /> class.
        /// </summary>
        ...
        public MosaicSupplyRevocationTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string sourceAddress = default(string), string mosaicId = default(string), string amount = default(string))
        {
            this.Size = size;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.Signature = signature;
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            ...
            if (maxFee == null)
            {
                throw new ArgumentNullException("maxFee is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.MaxFee = maxFee;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.Deadline = deadline;
            // to ensure "sourceAddress" is required (not null)
            if (sourceAddress == null)
            {
                throw new ArgumentNullException("sourceAddress is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.SourceAddress = sourceAddress;
            // to ensure "mosaicId" is required (not null)
            if (mosaicId == null)
            {
                throw new ArgumentNullException("mosaicId is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.MosaicId = mosaicId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for MosaicSupplyRevocationTransactionDTO and cannot be null");
            }
            this.Amount = amount;
        }

...
namespace SymbolRestClient.Model
{
    ...
    public partial class EmbeddedMosaicAddressRestrictionTransactionDTO : IValidatableObject
    {
        ...
        public EmbeddedMosaicAddressRestrictionTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string mosaicId = default(string), string restrictionKey = default(string), string previousRestrictionValue = default(string), string newRestrictionValue = default(string), string targetAddress = default(string))
        {

...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InflationReceiptDTO")]
    public partial class InflationReceiptDTO : IValidatableObject
    {
        ...
        public InflationReceiptDTO(int varVersion = default(int), ReceiptTypeEnum type = default(ReceiptTypeEnum), string mosaicId = default(string), string amount = default(string))
        {
            ...
            if (mosaicId == null)
            {
                throw new ArgumentNullException("mosaicId is a required property for InflationReceiptDTO and cannot be null");
            }
            this.MosaicId = mosaicId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for InflationReceiptDTO and cannot be null");
            }
            this.Amount = amount;
        }

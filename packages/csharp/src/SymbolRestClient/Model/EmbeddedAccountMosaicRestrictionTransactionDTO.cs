...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmbeddedAccountMosaicRestrictionTransactionDTO")]
    public partial class EmbeddedAccountMosaicRestrictionTransactionDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddedAccountMosaicRestrictionTransactionDTO" /> class.
        /// </summary>
        [JsonConstructor]
        protected EmbeddedAccountMosaicRestrictionTransactionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddedAccountMosaicRestrictionTransactionDTO" /> class.
        /// </summary>
        ...
        public EmbeddedAccountMosaicRestrictionTransactionDTO(string signerPublicKey = default(string), int varVersion = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<string> restrictionAdditions = default(List<string>), List<string> restrictionDeletions = default(List<string>))
        {
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new ArgumentNullException("signerPublicKey is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("restrictionAdditions is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            this.RestrictionAdditions = restrictionAdditions;
            // to ensure "restrictionDeletions" is required (not null)
            if (restrictionDeletions == null)
            {
                throw new ArgumentNullException("restrictionDeletions is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }

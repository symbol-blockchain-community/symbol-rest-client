...
namespace SymbolRestClient.Model
{
    ...
    public partial class BalanceChangeReceiptDTO : IValidatableObject
    {
        ...
        public BalanceChangeReceiptDTO(int varVersion = default(int), ReceiptTypeEnum type = default(ReceiptTypeEnum), string mosaicId = default(string), string amount = default(string), string targetAddress = default(string))
        {

...
namespace SymbolRestClient.Api
{
    ...
    public partial class MultisigRoutesApi : IMultisigRoutesApi
    {
        ...
        /// <returns></returns>
        public MultisigRoutesApi(Configuration configuration)
        {
        ...
        public MultisigRoutesApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MultisigAccountInfoDTO</returns>
        public ApiResponse<MultisigAccountInfoDTO> GetAccountMultisigWithHttpInfo(string address, int operationIndex = 0)
        {
        ...
        {
            ApiResponse<MultisigAccountInfoDTO> localVarResponse = await GetAccountMultisigWithHttpInfoAsync(address, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MultisigAccountInfoDTO)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MultisigAccountInfoDTO>> GetAccountMultisigWithHttpInfoAsync(string address, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;MultisigAccountGraphInfoDTO&gt;</returns>
        public ApiResponse<List<MultisigAccountGraphInfoDTO>> GetAccountMultisigGraphWithHttpInfo(string address, int operationIndex = 0)
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        {
            ApiResponse<List<MultisigAccountGraphInfoDTO>> localVarResponse = await GetAccountMultisigGraphWithHttpInfoAsync(address, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MultisigAccountGraphInfoDTO&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<MultisigAccountGraphInfoDTO>>> GetAccountMultisigGraphWithHttpInfoAsync(string address, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MerkleStateInfoDTO</returns>
        public ApiResponse<MerkleStateInfoDTO> GetAccountMultisigMerkleWithHttpInfo(string address, int operationIndex = 0)
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        {
            ApiResponse<MerkleStateInfoDTO> localVarResponse = await GetAccountMultisigMerkleWithHttpInfoAsync(address, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MerkleStateInfoDTO)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MerkleStateInfoDTO>> GetAccountMultisigMerkleWithHttpInfoAsync(string address, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {

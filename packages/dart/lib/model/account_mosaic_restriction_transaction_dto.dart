...
class AccountMosaicRestrictionTransactionDTO {
  /// Returns a new [AccountMosaicRestrictionTransactionDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountMosaicRestrictionTransactionDTO &&
    other.size == size &&
  ...
  @override
  String toString() => 'AccountMosaicRestrictionTransactionDTO[size=$size, signature=$signature, signerPublicKey=$signerPublicKey, version=$version, network=$network, type=$type, maxFee=$maxFee, deadline=$deadline, restrictionFlags=$restrictionFlags, restrictionAdditions=$restrictionAdditions, restrictionDeletions=$restrictionDeletions]';
  ...
  /// Returns a new [AccountMosaicRestrictionTransactionDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountMosaicRestrictionTransactionDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountMosaicRestrictionTransactionDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountMosaicRestrictionTransactionDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountMosaicRestrictionTransactionDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountMosaicRestrictionTransactionDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountMosaicRestrictionTransactionDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountMosaicRestrictionTransactionDTO> mapFromJson(dynamic json) {
    final map = <String, AccountMosaicRestrictionTransactionDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountMosaicRestrictionTransactionDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountMosaicRestrictionTransactionDTO-objects as value to a dart map
  static Map<String, List<AccountMosaicRestrictionTransactionDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountMosaicRestrictionTransactionDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AccountMosaicRestrictionTransactionDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

...
class SecretProofTransactionDTO {
  /// Returns a new [SecretProofTransactionDTO] instance.
  ...
  /// Returns a new [SecretProofTransactionDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SecretProofTransactionDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SecretProofTransactionDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SecretProofTransactionDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SecretProofTransactionDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SecretProofTransactionDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SecretProofTransactionDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SecretProofTransactionDTO> mapFromJson(dynamic json) {
    final map = <String, SecretProofTransactionDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SecretProofTransactionDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SecretProofTransactionDTO-objects as value to a dart map
  static Map<String, List<SecretProofTransactionDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SecretProofTransactionDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SecretProofTransactionDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

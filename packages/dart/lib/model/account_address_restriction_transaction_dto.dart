...
class AccountAddressRestrictionTransactionDTO {
  /// Returns a new [AccountAddressRestrictionTransactionDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountAddressRestrictionTransactionDTO &&
    other.size == size &&
  ...
  @override
  String toString() => 'AccountAddressRestrictionTransactionDTO[size=$size, signature=$signature, signerPublicKey=$signerPublicKey, version=$version, network=$network, type=$type, maxFee=$maxFee, deadline=$deadline, restrictionFlags=$restrictionFlags, restrictionAdditions=$restrictionAdditions, restrictionDeletions=$restrictionDeletions]';
  ...
  /// Returns a new [AccountAddressRestrictionTransactionDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountAddressRestrictionTransactionDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountAddressRestrictionTransactionDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountAddressRestrictionTransactionDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountAddressRestrictionTransactionDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountAddressRestrictionTransactionDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountAddressRestrictionTransactionDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountAddressRestrictionTransactionDTO> mapFromJson(dynamic json) {
    final map = <String, AccountAddressRestrictionTransactionDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountAddressRestrictionTransactionDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountAddressRestrictionTransactionDTO-objects as value to a dart map
  static Map<String, List<AccountAddressRestrictionTransactionDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountAddressRestrictionTransactionDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AccountAddressRestrictionTransactionDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

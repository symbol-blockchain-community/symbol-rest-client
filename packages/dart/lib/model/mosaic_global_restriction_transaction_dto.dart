...
class MosaicGlobalRestrictionTransactionDTO {
  /// Returns a new [MosaicGlobalRestrictionTransactionDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MosaicGlobalRestrictionTransactionDTO &&
    other.size == size &&
  ...
  @override
  String toString() => 'MosaicGlobalRestrictionTransactionDTO[size=$size, signature=$signature, signerPublicKey=$signerPublicKey, version=$version, network=$network, type=$type, maxFee=$maxFee, deadline=$deadline, mosaicId=$mosaicId, referenceMosaicId=$referenceMosaicId, restrictionKey=$restrictionKey, previousRestrictionValue=$previousRestrictionValue, newRestrictionValue=$newRestrictionValue, previousRestrictionType=$previousRestrictionType, newRestrictionType=$newRestrictionType]';
  ...
  /// Returns a new [MosaicGlobalRestrictionTransactionDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MosaicGlobalRestrictionTransactionDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MosaicGlobalRestrictionTransactionDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MosaicGlobalRestrictionTransactionDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MosaicGlobalRestrictionTransactionDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MosaicGlobalRestrictionTransactionDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MosaicGlobalRestrictionTransactionDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MosaicGlobalRestrictionTransactionDTO> mapFromJson(dynamic json) {
    final map = <String, MosaicGlobalRestrictionTransactionDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MosaicGlobalRestrictionTransactionDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MosaicGlobalRestrictionTransactionDTO-objects as value to a dart map
  static Map<String, List<MosaicGlobalRestrictionTransactionDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MosaicGlobalRestrictionTransactionDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MosaicGlobalRestrictionTransactionDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

...
class ResolutionEntryDTOResolved {
  ...
  /// Returns a new [ResolutionEntryDTOResolved] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ResolutionEntryDTOResolved? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ResolutionEntryDTOResolved> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ResolutionEntryDTOResolved.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ResolutionEntryDTOResolved> mapFromJson(dynamic json) {
    final map = <String, ResolutionEntryDTOResolved>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ResolutionEntryDTOResolved.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }

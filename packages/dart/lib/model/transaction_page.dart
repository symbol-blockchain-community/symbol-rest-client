...
class TransactionPage {
  ...
  @override
  String toString() => 'TransactionPage[data=$data, pagination=$pagination]';
  ...
  static TransactionPage? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TransactionPage(
        data: TransactionInfoDTO.listFromJson(json[r'data']),
  ...
  static Map<String, List<TransactionPage>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TransactionPage.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

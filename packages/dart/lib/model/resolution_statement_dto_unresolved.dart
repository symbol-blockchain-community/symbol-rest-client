...
class ResolutionStatementDTOUnresolved {
  ...
  /// Returns a new [ResolutionStatementDTOUnresolved] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ResolutionStatementDTOUnresolved? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ResolutionStatementDTOUnresolved> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ResolutionStatementDTOUnresolved.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ResolutionStatementDTOUnresolved> mapFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ResolutionStatementDTOUnresolved.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }

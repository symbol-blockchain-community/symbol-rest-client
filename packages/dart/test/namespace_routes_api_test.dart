...
/// tests for NamespaceRoutesApi
void main() {
  // final instance = NamespaceRoutesApi();

  group('tests for NamespaceRoutesApi', () {
    // Get readable names for a set of accountIds
    //
    // Returns friendly names for accounts.
    //
    //Future<AccountsNamesDTO> getAccountsNames(Addresses addresses) async
    test('test getAccountsNames', () async {
      // TODO
    });
    ...
    test('test getMosaicsNames', () async {
      // TODO
    });
    ...
    test('test getNamespaceMerkle', () async {
      // TODO
    });
    ...
    test('test getNamespacesNames', () async {
      // TODO
    });
    ...
    test('test searchNamespaces', () async {
      // TODO
    });

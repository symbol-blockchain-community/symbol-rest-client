...
/// tests for AccountRoutesApi
void main() {
  // final instance = AccountRoutesApi();

  group('tests for AccountRoutesApi', () {
    ...
    test('test getAccountInfoMerkle', () async {
      // TODO
    });
    ...
    test('test getAccountsInfo', () async {
      // TODO
    });
    ...
    test('test searchAccounts', () async {
      // TODO
    });

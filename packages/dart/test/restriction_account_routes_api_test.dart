...
/// tests for RestrictionAccountRoutesApi
void main() {
  // final instance = RestrictionAccountRoutesApi();

  group('tests for RestrictionAccountRoutesApi', () {
    ...
    test('test getAccountRestrictions', () async {
      // TODO
    });
    ...
    test('test getAccountRestrictionsMerkle', () async {
      // TODO
    });
    ...
    test('test searchAccountRestrictions', () async {
      // TODO
    });

...
// tests for MosaicAddressRestrictionTransactionBodyDTO
void main() {
  // final instance = MosaicAddressRestrictionTransactionBodyDTO();

  group('test MosaicAddressRestrictionTransactionBodyDTO', () {

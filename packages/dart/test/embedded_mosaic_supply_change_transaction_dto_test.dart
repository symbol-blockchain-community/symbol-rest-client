...
// tests for EmbeddedMosaicSupplyChangeTransactionDTO
void main() {
  // final instance = EmbeddedMosaicSupplyChangeTransactionDTO();

  group('test EmbeddedMosaicSupplyChangeTransactionDTO', () {
    // Public key.

...
// tests for AccountMosaicRestrictionTransactionDTO
void main() {
  // final instance = AccountMosaicRestrictionTransactionDTO();

  group('test AccountMosaicRestrictionTransactionDTO', () {

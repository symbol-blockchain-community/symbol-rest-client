...
// tests for MosaicAddressRestrictionTransactionDTO
void main() {
  // final instance = MosaicAddressRestrictionTransactionDTO();

  group('test MosaicAddressRestrictionTransactionDTO', () {

...
// tests for ImportanceBlockDTO
void main() {
  // final instance = ImportanceBlockDTO();

  group('test ImportanceBlockDTO', () {
    ...
    test('to test the property `votingEligibleAccountsCount`', () async {
      // TODO
    });

    // A number that allows uint 64 values represented with a string.
    // String harvestingEligibleAccountsCount
    test('to test the property `harvestingEligibleAccountsCount`', () async {
      // TODO
    });

    // Absolute amount. An amount of 123456789 (absolute) for a mosaic with divisibility 6 means 123.456789 (relative).
    // String totalVotingBalance
    test('to test the property `totalVotingBalance`', () async {
      // TODO
    });

    // String previousImportanceBlockHash
    test('to test the property `previousImportanceBlockHash`', () async {
      // TODO
    });

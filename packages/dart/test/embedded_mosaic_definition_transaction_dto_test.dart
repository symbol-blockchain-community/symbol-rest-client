...
// tests for EmbeddedMosaicDefinitionTransactionDTO
void main() {
  // final instance = EmbeddedMosaicDefinitionTransactionDTO();

  group('test EmbeddedMosaicDefinitionTransactionDTO', () {
    // Public key.

...
// tests for EmbeddedNamespaceRegistrationTransactionDTO
void main() {
  // final instance = EmbeddedNamespaceRegistrationTransactionDTO();

  group('test EmbeddedNamespaceRegistrationTransactionDTO', () {
    // Public key.

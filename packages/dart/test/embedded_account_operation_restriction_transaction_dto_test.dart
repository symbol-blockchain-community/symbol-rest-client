...
// tests for EmbeddedAccountOperationRestrictionTransactionDTO
void main() {
  // final instance = EmbeddedAccountOperationRestrictionTransactionDTO();

  group('test EmbeddedAccountOperationRestrictionTransactionDTO', () {
    // Public key.

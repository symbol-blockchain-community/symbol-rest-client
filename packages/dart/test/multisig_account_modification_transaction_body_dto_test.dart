...
// tests for MultisigAccountModificationTransactionBodyDTO
void main() {
  // final instance = MultisigAccountModificationTransactionBodyDTO();

  group('test MultisigAccountModificationTransactionBodyDTO', () {

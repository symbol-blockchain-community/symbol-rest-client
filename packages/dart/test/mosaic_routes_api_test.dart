...
/// tests for MosaicRoutesApi
void main() {
  // final instance = MosaicRoutesApi();

  group('tests for MosaicRoutesApi', () {
    // Get mosaic information
    //
    // Gets the mosaic definition for a given mosaic identifier.
    //
    //Future<MosaicInfoDTO> getMosaic(String mosaicId) async
    test('test getMosaic', () async {
      // TODO
    });
    ...
    test('test getMosaicMerkle', () async {
      // TODO
    });

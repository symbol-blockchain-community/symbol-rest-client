...
// tests for AggregateNetworkPropertiesDTO
void main() {
  // final instance = AggregateNetworkPropertiesDTO();

  group('test AggregateNetworkPropertiesDTO', () {
    // Maximum number of transactions per aggregate.
    // String maxTransactionsPerAggregate
    test('to test the property `maxTransactionsPerAggregate`', () async {
      // TODO
    });

    // Maximum number of cosignatures per aggregate.
    // String maxCosignaturesPerAggregate
    test('to test the property `maxCosignaturesPerAggregate`', () async {
      // TODO
    });
    ...
    test('to test the property `enableStrictCosignatureCheck`', () async {
      // TODO
    });
    ...
    test('to test the property `enableBondedAggregateSupport`', () async {
      // TODO
    });

    // Maximum lifetime a bonded transaction can have before it expires.
    // String maxBondedTransactionLifetime
    test('to test the property `maxBondedTransactionLifetime`', () async {
      // TODO
    });
  });
}

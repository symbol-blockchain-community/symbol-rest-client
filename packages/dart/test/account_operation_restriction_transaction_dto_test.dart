...
// tests for AccountOperationRestrictionTransactionDTO
void main() {
  // final instance = AccountOperationRestrictionTransactionDTO();

  group('test AccountOperationRestrictionTransactionDTO', () {

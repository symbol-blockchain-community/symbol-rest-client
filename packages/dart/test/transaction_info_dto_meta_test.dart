...
// tests for TransactionInfoDTOMeta
void main() {
  // final instance = TransactionInfoDTOMeta();

  group('test TransactionInfoDTOMeta', () {
    ...
    test('to test the property `merkleComponentHash`', () async {
      // TODO
    });
    ...
    test('to test the property `aggregateHash`', () async {
      // TODO
    });

    // Identifier of the aggregate transaction.
    // String aggregateId
    test('to test the property `aggregateId`', () async {
      // TODO
    });

...
// tests for EmbeddedAccountAddressRestrictionTransactionDTO
void main() {
  // final instance = EmbeddedAccountAddressRestrictionTransactionDTO();

  group('test EmbeddedAccountAddressRestrictionTransactionDTO', () {
    // Public key.

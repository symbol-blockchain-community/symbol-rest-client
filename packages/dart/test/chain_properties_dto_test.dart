...
// tests for ChainPropertiesDTO
void main() {
  // final instance = ChainPropertiesDTO();

  group('test ChainPropertiesDTO', () {
    ...
    test('to test the property `enableVerifiableState`', () async {
      // TODO
    });
    ...
    test('to test the property `minHarvesterBalance`', () async {
      // TODO
    });

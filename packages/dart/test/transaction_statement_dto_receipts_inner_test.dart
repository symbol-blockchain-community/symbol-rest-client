...
// tests for TransactionStatementDTOReceiptsInner
void main() {
  // final instance = TransactionStatementDTOReceiptsInner();

  group('test TransactionStatementDTOReceiptsInner', () {
    ...
    test('to test the property `senderAddress`', () async {
      // TODO
    });

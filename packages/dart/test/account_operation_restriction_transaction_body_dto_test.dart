...
// tests for AccountOperationRestrictionTransactionBodyDTO
void main() {
  // final instance = AccountOperationRestrictionTransactionBodyDTO();

  group('test AccountOperationRestrictionTransactionBodyDTO', () {

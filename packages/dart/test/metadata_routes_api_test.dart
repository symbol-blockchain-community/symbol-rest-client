...
/// tests for MetadataRoutesApi
void main() {
  // final instance = MetadataRoutesApi();

  group('tests for MetadataRoutesApi', () {
    ...
    test('test getMetadataMerkle', () async {
      // TODO
    });
    ...
    test('test searchMetadataEntries', () async {
      // TODO
    });

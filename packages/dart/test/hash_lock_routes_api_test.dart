...
/// tests for HashLockRoutesApi
void main() {
  // final instance = HashLockRoutesApi();

  group('tests for HashLockRoutesApi', () {
    // Get hash lock information
    //
    // Gets the hash lock for a given hash.
    //
    //Future<HashLockInfoDTO> getHashLock(String hash) async
    test('test getHashLock', () async {
      // TODO
    });
    ...
    test('test getHashLockMerkle', () async {
      // TODO
    });
    ...
    test('test searchHashLock', () async {
      // TODO
    });
  });
}

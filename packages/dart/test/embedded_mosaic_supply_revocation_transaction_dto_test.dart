...
// tests for EmbeddedMosaicSupplyRevocationTransactionDTO
void main() {
  // final instance = EmbeddedMosaicSupplyRevocationTransactionDTO();

  group('test EmbeddedMosaicSupplyRevocationTransactionDTO', () {
    // Public key.

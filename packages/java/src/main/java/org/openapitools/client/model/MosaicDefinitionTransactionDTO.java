...
public class MosaicDefinitionTransactionDTO {
  ...
  public MosaicDefinitionTransactionDTO() {
  }
  ...
  **/
  ...
  public MosaicDefinitionTransactionDTO maxFee(String maxFee) {
    this.maxFee = maxFee;
    return this;
  }
  ...
  **/
  ...
  public MosaicDefinitionTransactionDTO deadline(String deadline) {
  ...
  **/
  ...
  public MosaicDefinitionTransactionDTO duration(String duration) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to MosaicDefinitionTransactionDTO
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MosaicDefinitionTransactionDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MosaicDefinitionTransactionDTO is not found in the empty JSON string", MosaicDefinitionTransactionDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MosaicDefinitionTransactionDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MosaicDefinitionTransactionDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MosaicDefinitionTransactionDTO.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MosaicDefinitionTransactionDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MosaicDefinitionTransactionDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MosaicDefinitionTransactionDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MosaicDefinitionTransactionDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<MosaicDefinitionTransactionDTO>() {
           @Override
           public void write(JsonWriter out, MosaicDefinitionTransactionDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MosaicDefinitionTransactionDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MosaicDefinitionTransactionDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MosaicDefinitionTransactionDTO
  * @throws IOException if the JSON string is invalid with respect to MosaicDefinitionTransactionDTO
  */
  public static MosaicDefinitionTransactionDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MosaicDefinitionTransactionDTO.class);
  }

 /**
  * Convert an instance of MosaicDefinitionTransactionDTO to an JSON string
  *
  * @return JSON string
  */

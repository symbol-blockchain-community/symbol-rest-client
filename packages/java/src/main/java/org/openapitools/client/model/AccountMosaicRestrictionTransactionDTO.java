...
public class AccountMosaicRestrictionTransactionDTO {
  ...
  public AccountMosaicRestrictionTransactionDTO size(Long size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public AccountMosaicRestrictionTransactionDTO maxFee(String maxFee) {
    this.maxFee = maxFee;
    return this;
  }
  ...
  **/
  ...
  public AccountMosaicRestrictionTransactionDTO deadline(String deadline) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, accountMosaicRestrictionTransactionDTO.size) &&
        Objects.equals(this.signature, accountMosaicRestrictionTransactionDTO.signature) &&
        Objects.equals(this.signerPublicKey, accountMosaicRestrictionTransactionDTO.signerPublicKey) &&
        Objects.equals(this.version, accountMosaicRestrictionTransactionDTO.version) &&
        Objects.equals(this.network, accountMosaicRestrictionTransactionDTO.network) &&
        Objects.equals(this.type, accountMosaicRestrictionTransactionDTO.type) &&
        Objects.equals(this.maxFee, accountMosaicRestrictionTransactionDTO.maxFee) &&
        Objects.equals(this.deadline, accountMosaicRestrictionTransactionDTO.deadline) &&
        Objects.equals(this.restrictionFlags, accountMosaicRestrictionTransactionDTO.restrictionFlags) &&
        Objects.equals(this.restrictionAdditions, accountMosaicRestrictionTransactionDTO.restrictionAdditions) &&
        Objects.equals(this.restrictionDeletions, accountMosaicRestrictionTransactionDTO.restrictionDeletions);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccountMosaicRestrictionTransactionDTO
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountMosaicRestrictionTransactionDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountMosaicRestrictionTransactionDTO is not found in the empty JSON string", AccountMosaicRestrictionTransactionDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountMosaicRestrictionTransactionDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountMosaicRestrictionTransactionDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountMosaicRestrictionTransactionDTO.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountMosaicRestrictionTransactionDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountMosaicRestrictionTransactionDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountMosaicRestrictionTransactionDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountMosaicRestrictionTransactionDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountMosaicRestrictionTransactionDTO>() {
           @Override
           public void write(JsonWriter out, AccountMosaicRestrictionTransactionDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountMosaicRestrictionTransactionDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccountMosaicRestrictionTransactionDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountMosaicRestrictionTransactionDTO
  * @throws IOException if the JSON string is invalid with respect to AccountMosaicRestrictionTransactionDTO
  */
  public static AccountMosaicRestrictionTransactionDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountMosaicRestrictionTransactionDTO.class);
  }

 /**
  * Convert an instance of AccountMosaicRestrictionTransactionDTO to an JSON string
  *
  * @return JSON string
  */

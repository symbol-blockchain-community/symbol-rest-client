...
public class AccountOperationRestrictionTransactionDTO {
  ...
  public AccountOperationRestrictionTransactionDTO size(Long size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public AccountOperationRestrictionTransactionDTO maxFee(String maxFee) {
    this.maxFee = maxFee;
    return this;
  }
  ...
  **/
  ...
  public AccountOperationRestrictionTransactionDTO deadline(String deadline) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, accountOperationRestrictionTransactionDTO.size) &&
        Objects.equals(this.signature, accountOperationRestrictionTransactionDTO.signature) &&
        Objects.equals(this.signerPublicKey, accountOperationRestrictionTransactionDTO.signerPublicKey) &&
        Objects.equals(this.version, accountOperationRestrictionTransactionDTO.version) &&
        Objects.equals(this.network, accountOperationRestrictionTransactionDTO.network) &&
        Objects.equals(this.type, accountOperationRestrictionTransactionDTO.type) &&
        Objects.equals(this.maxFee, accountOperationRestrictionTransactionDTO.maxFee) &&
        Objects.equals(this.deadline, accountOperationRestrictionTransactionDTO.deadline) &&
        Objects.equals(this.restrictionFlags, accountOperationRestrictionTransactionDTO.restrictionFlags) &&
        Objects.equals(this.restrictionAdditions, accountOperationRestrictionTransactionDTO.restrictionAdditions) &&
        Objects.equals(this.restrictionDeletions, accountOperationRestrictionTransactionDTO.restrictionDeletions);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccountOperationRestrictionTransactionDTO
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountOperationRestrictionTransactionDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountOperationRestrictionTransactionDTO is not found in the empty JSON string", AccountOperationRestrictionTransactionDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountOperationRestrictionTransactionDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountOperationRestrictionTransactionDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountOperationRestrictionTransactionDTO.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountOperationRestrictionTransactionDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountOperationRestrictionTransactionDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountOperationRestrictionTransactionDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountOperationRestrictionTransactionDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountOperationRestrictionTransactionDTO>() {
           @Override
           public void write(JsonWriter out, AccountOperationRestrictionTransactionDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountOperationRestrictionTransactionDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccountOperationRestrictionTransactionDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountOperationRestrictionTransactionDTO
  * @throws IOException if the JSON string is invalid with respect to AccountOperationRestrictionTransactionDTO
  */
  public static AccountOperationRestrictionTransactionDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountOperationRestrictionTransactionDTO.class);
  }

 /**
  * Convert an instance of AccountOperationRestrictionTransactionDTO to an JSON string
  *
  * @return JSON string
  */
